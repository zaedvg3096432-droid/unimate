...
class MoreScreen extends ConsumerWidget {
  ...
  void _showFocus(BuildContext context) { showDialog<void>(context: context, builder: (_) => AlertDialog(title: Text(context.t('focusExam')), content: Text(context.t('focusHint')), actions: [FilledButton(onPressed: () => Navigator.pop(context), child: Text(context.t('start'))), TextButton(onPressed: () => Navigator.pop(context), child: Text(context.t('close')))])); }
